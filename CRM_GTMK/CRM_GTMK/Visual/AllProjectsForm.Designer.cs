namespace CRM_GTMK.Visual
{
	partial class AllProjectsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tableLayoutPanel2.Controls.Add(this.progressBar2, 2, 1);
			...
			this.tableLayoutPanel2.Controls.Add(this.label10, 7, 1);
			this.tableLayoutPanel2.Controls.Add(this.label11, 8, 1);
			this.tableLayoutPanel2.Controls.Add(this.button5, 9, 1);
			...
			this.tableLayoutPanel2.Size = new System.Drawing.Size(736, 100);
			this.tableLayoutPanel2.TabIndex = 3;
			// 
			// panel2
			// 
			this.tableLayoutPanel2.SetColumnSpan(this.panel2, 10);
			...
			this.label4.Text = "Название папки";
			// 
			// label3
			// 
			...
			// progressBar2
			// 
			this.progressBar2.Location = new System.Drawing.Point(167, 44);
			...
			this.label8.Size = new System.Drawing.Size(53, 59);
			this.label8.TabIndex = 8;
			this.label8.Text = "Прогресс бар с процентов распределенных сегментов";
			// 
			// label9
			// 
			...
			this.label9.Text = "Должны завершить 20.12 18:00";
			// 
			// label10
			// 
			...
			this.label10.Text = "Делайн 24.12.2017 15:00";
			// 
			// label11
			// 
			this.label11.AutoSize = true;
			this.label11.Location = new System.Drawing.Point(616, 41);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(60, 52);
			this.label11.TabIndex = 11;
			this.label11.Text = "Иконка с ресунком, все ок или аларм";
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(682, 44);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(51, 23);
			this.button5.TabIndex = 12;
			this.button5.Text = "Ускорить";
			...
			this.label1.Text = "Тестовый проект";
			// 
			// checkBox1
			// 
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(350, 4);
			...
			this.progressBar1.Location = new System.Drawing.Point(143, 7);
			...
			this.label2.Text = "25.12.2017 18:30";
			// 
			// tableLayoutPanel3
			// 
			...
			this.tableLayoutPanel3.Location = new System.Drawing.Point(41, 44);
			this.tableLayoutPanel3.Name = "tableLayoutPanel3";
			this.tableLayoutPanel3.RowCount = 2;
			this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.tableLayoutPanel3.Size = new System.Drawing.Size(739, 100);
